...
class Cart extends CI_Controller {
	...
	public function add()
	{
		...
		$this->session->set_flashdata('success', 'Berhasil ditambahkan ke dalam keranjang anda.');
	...
	{		
		...
		$this->session->set_flashdata('success', 'Berhasil menghapus produk dari keranjang anda.');
