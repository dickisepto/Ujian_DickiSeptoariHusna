						...
						<div class="col-10">
							<form action="<?= base_url('register/register') ?>" method="POST" class="form-signin">
								<div class="text-center">
									<img class="mb-2" src="<?= base_url() ?>images/logo/logo.png" width="400" height="150"> <!-- logo -->
								</div>
			
								<h1 class="h3 mb-3 font-weight-normal text-center">Register</h1>
<br><center><p><a href='https://septogamespot.com/' title='StokCoding.com' target='_blank'>SeptoGameSpot.com</a></p></center>
