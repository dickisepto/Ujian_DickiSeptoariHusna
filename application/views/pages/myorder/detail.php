			...
			<div class="card">
				...
				<div class="card-body">
					<ul>
						...
						<li>Telpon : <?= $order['phone'] ?></li>
						<li>Alamat  : <?= $order['address'] ?></li>
						<li>Ongkir Daerah : <?=$order['area'] ?></li>
						<li>Status  : 
					...
					<div class="text-center text-info">
						<small class="text-dark">Bila anda butuh bantuan atau informasi, silahkan hubungi kontak ini.</small>
						<br>
						<small>septoarihusna@gmail.com | 0895334029497</small>
					</div>
