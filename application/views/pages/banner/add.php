<div class="container">
	<div class="row mt-4">
		<div class="col">
			<h2 class="text-center"> Tambahkan Banner </h2>
		</div>
	</div>
	...
	<div class="row bg-light p-3 mt-4">
		<div class="col">
			...
			<?= form_open_multipart(base_url('banner/add')) ?>
				...
				<div class="form-group row">
					<label class="col-sm-2 col-form-label font-weight-bold">Isi Banner</label>
					<div class="col-sm-10">
				...
				<div class="form-group row">
					<label class="col-sm-2 col-form-label font-weight-bold">Tombol Link</label>
					<div class="col-sm-10">
